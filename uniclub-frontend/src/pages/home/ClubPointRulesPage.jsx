...
function ClubPointRulesPage({ clubId, isLeader = false }) {
  ...
  async function handleDeleteRule(rule) {
    ...
    try {
      await deletePointRule(clubId, rule.id)
      showToast({
        type: 'success',
        title: 'Rule deleted',
        message: `${rule.title} has been deleted successfully.`,
      })
      await refreshRules()
    } catch (err) {
      console.error(err)
      showToast({
        type: 'error',
        title: 'Delete failed',
        message: err.message || 'Could not delete point rule.',
      })
    }
  }
                  ...
                  <div className="club-point-rule-card__top">
                    ...
                    {isManager ? (
                      <div className="club-point-rule-card__actions">
                        ...
                        <button
                          type="button"
                          className="club-point-rule-card__delete-btn"
